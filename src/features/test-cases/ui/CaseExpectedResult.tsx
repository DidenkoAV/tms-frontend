...
export default function CaseExpectedResult(props: Props) {
  if (props.mode === "form") {
    const { value, onChange, label = "Expected result", placeholder } = props;
    return (
      <div className={sectionClasses}>
        ...
        <textarea
          ...
          placeholder={placeholder ?? "Describe what should happen..."}
        />
      </div>
    );
  }
